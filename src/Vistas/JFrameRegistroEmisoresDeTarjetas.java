/*
* este JFrame registra (agrega, borra, edita, busca y filtra) todos los emisores de tarjetas
 */
package Vistas;
...
public class JFrameRegistroEmisoresDeTarjetas extends javax.swing.JFrame {
// atributos y variables    
    private final AdministradorEmisoresDeTarjetas _administradorEmisoresDeTarjetas;
    private EmisoresDeTarjetas _objEmisoresDeTarjetas;
    private TableModel modeloTablaEDT;
    private String iuEmisoresDeTarjetas;
    private int auxAbm;
    
    public JFrameRegistroEmisoresDeTarjetas() {
        initComponents();
// se personaliza las fuentes de letra de los objetos grafico
        ...
        jLabelTituloIuEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldIuEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 7));
        jLabelTituloDescrEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldDescrEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
        jLabelTituloBuscarEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldBuscarEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
...
// se personaliza el jTable    
        jTableEmisoresDeTarjetas.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 6));
        JTableHeader auxJTableHeader;
        auxJTableHeader = jTableEmisoresDeTarjetas.getTableHeader();
        auxJTableHeader.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 7));
// se instancia la clase AdministradorEmisoresDeTarjetas y se inicializa el menu del jTable
        _administradorEmisoresDeTarjetas = new AdministradorEmisoresDeTarjetas();
        popupMenuJTable();
        
        jTextFieldIuEmisoresDeTarjetas.setEditable(false);
        jButtonBorrarEmisoresDeTarjetas.setEnabled(false);
        jButtonEditarEmisoresDeTarjetas.setEnabled(false);
    }   
    ...
    private void initComponents() {
        ...
        jSeparatorBuscarEmisoresDeTarjetas = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTableEmisoresDeTarjetas = new javax.swing.JTable();
        jLabelTituloBuscarEmisoresDeTarjetas = new javax.swing.JLabel();
        jTextFieldBuscarEmisoresDeTarjetas = new javax.swing.JTextField();
        jButtonTraerPanelCuerpo = new javax.swing.JButton();
        jLabelFondoVentanaBuscar = new javax.swing.JLabel();
        jPanelCuerpo = new javax.swing.JPanel();
        jLabelTituloDescrEmisoresDeTarjetas = new javax.swing.JLabel();
        jTextFieldDescrEmisoresDeTarjetas = new javax.swing.JTextField();
        jSeparatorDescrEmisoresDeTarjetas = new javax.swing.JSeparator();
        jSeparatorIuEmisoresDeTarjetas = new javax.swing.JSeparator();
        jLabelTituloIuEmisoresDeTarjetas = new javax.swing.JLabel();
        jTextFieldIuEmisoresDeTarjetas = new javax.swing.JTextField();
        jButtonAgregarEmisoresDeTarjetas = new javax.swing.JButton();
        jButtonEditarEmisoresDeTarjetas = new javax.swing.JButton();
        jButtonBorrarEmisoresDeTarjetas = new javax.swing.JButton();
        ...
        jSeparatorBuscarEmisoresDeTarjetas.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorBuscarEmisoresDeTarjetas.setForeground(new java.awt.Color(0, 0, 0));
        jPanelVentanaBuscar.add(jSeparatorBuscarEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 55, 100, 2));
        ...
        jTableEmisoresDeTarjetas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jTableEmisoresDeTarjetas.setToolTipText("Has click derecho para opciones.");
        jTableEmisoresDeTarjetas.setAutoscrolls(false);
        jTableEmisoresDeTarjetas.setFocusable(false);
        jTableEmisoresDeTarjetas.setMaximumSize(new java.awt.Dimension(480, 206));
        jTableEmisoresDeTarjetas.setMinimumSize(new java.awt.Dimension(480, 206));
        jTableEmisoresDeTarjetas.setPreferredSize(new java.awt.Dimension(480, 206));
        jTableEmisoresDeTarjetas.setSelectionBackground(new java.awt.Color(73, 73, 73));
        jTableEmisoresDeTarjetas.setSelectionForeground(new java.awt.Color(245, 245, 245));
        jTableEmisoresDeTarjetas.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jTableEmisoresDeTarjetas);
        jTableEmisoresDeTarjetas.getAccessibleContext().setAccessibleName("");

        jPanelVentanaBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 480, 146));

        jLabelTituloBuscarEmisoresDeTarjetas.setText("Parametro de busqueda:");
        jPanelVentanaBuscar.add(jLabelTituloBuscarEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 10, -1, 25));

        jTextFieldBuscarEmisoresDeTarjetas.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldBuscarEmisoresDeTarjetas.setToolTipText("ingresa parametros de busqueda. Ej: chev");
        jTextFieldBuscarEmisoresDeTarjetas.setBorder(null);
        jTextFieldBuscarEmisoresDeTarjetas.setDisabledTextColor(new java.awt.Color(194, 4, 48));
        jTextFieldBuscarEmisoresDeTarjetas.setOpaque(false);
        jTextFieldBuscarEmisoresDeTarjetas.setSelectionColor(new java.awt.Color(73, 73, 73));
        jTextFieldBuscarEmisoresDeTarjetas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBuscarEmisoresDeTarjetasKeyReleased(evt);
            }
        });
        jPanelVentanaBuscar.add(jTextFieldBuscarEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 35, 100, 20));
        ...
        jPanelVentanaBuscar.getAccessibleContext().setAccessibleName("");
        ...
        jLabelTituloDescrEmisoresDeTarjetas.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloDescrEmisoresDeTarjetas.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloDescrEmisoresDeTarjetas.setText("Emisores de la tarjetas:");
        jLabelTituloDescrEmisoresDeTarjetas.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloDescrEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 98, -1, 25));

        jTextFieldDescrEmisoresDeTarjetas.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldDescrEmisoresDeTarjetas.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldDescrEmisoresDeTarjetas.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldDescrEmisoresDeTarjetas.setToolTipText("Ingrese solo alfanumericos y simbolos(-) o (.). Ej.: visa");
        jTextFieldDescrEmisoresDeTarjetas.setBorder(null);
        jTextFieldDescrEmisoresDeTarjetas.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrEmisoresDeTarjetas.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrEmisoresDeTarjetas.setOpaque(false);
        jTextFieldDescrEmisoresDeTarjetas.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrEmisoresDeTarjetas.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldDescrEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 118, 200, 20));

        jSeparatorDescrEmisoresDeTarjetas.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrEmisoresDeTarjetas.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrEmisoresDeTarjetas.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorDescrEmisoresDeTarjetas.setOpaque(true);
        jPanelCuerpo.add(jSeparatorDescrEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 138, 200, -1));

        jSeparatorIuEmisoresDeTarjetas.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorIuEmisoresDeTarjetas.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorIuEmisoresDeTarjetas.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorIuEmisoresDeTarjetas.setOpaque(true);
        jPanelCuerpo.add(jSeparatorIuEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 66, 100, -1));

        jLabelTituloIuEmisoresDeTarjetas.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloIuEmisoresDeTarjetas.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloIuEmisoresDeTarjetas.setText("Codigo identificacion:");
        jLabelTituloIuEmisoresDeTarjetas.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloIuEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 25, -1, 25));

        jTextFieldIuEmisoresDeTarjetas.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldIuEmisoresDeTarjetas.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldIuEmisoresDeTarjetas.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldIuEmisoresDeTarjetas.setText("AUTOMATICO");
        jTextFieldIuEmisoresDeTarjetas.setToolTipText("");
        jTextFieldIuEmisoresDeTarjetas.setBorder(null);
        jTextFieldIuEmisoresDeTarjetas.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldIuEmisoresDeTarjetas.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldIuEmisoresDeTarjetas.setOpaque(false);
        jTextFieldIuEmisoresDeTarjetas.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldIuEmisoresDeTarjetas.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldIuEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 45, 100, 20));

        jButtonAgregarEmisoresDeTarjetas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOff.png"))); // NOI18N
        jButtonAgregarEmisoresDeTarjetas.setToolTipText("Has click para agregar.");
        jButtonAgregarEmisoresDeTarjetas.setBorder(null);
        jButtonAgregarEmisoresDeTarjetas.setBorderPainted(false);
        jButtonAgregarEmisoresDeTarjetas.setContentAreaFilled(false);
        jButtonAgregarEmisoresDeTarjetas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonAgregarEmisoresDeTarjetas.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarEmisoresDeTarjetas.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarEmisoresDeTarjetas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAgregarEmisoresDeTarjetasActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonAgregarEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 176, -1, -1));

        jButtonEditarEmisoresDeTarjetas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOff.png"))); // NOI18N
        jButtonEditarEmisoresDeTarjetas.setToolTipText("Has click para editar.");
        jButtonEditarEmisoresDeTarjetas.setBorder(null);
        jButtonEditarEmisoresDeTarjetas.setBorderPainted(false);
        jButtonEditarEmisoresDeTarjetas.setContentAreaFilled(false);
        jButtonEditarEmisoresDeTarjetas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonEditarEmisoresDeTarjetas.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarEmisoresDeTarjetas.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarEmisoresDeTarjetas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEditarEmisoresDeTarjetasActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonEditarEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 176, -1, -1));

        jButtonBorrarEmisoresDeTarjetas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOff.png"))); // NOI18N
        jButtonBorrarEmisoresDeTarjetas.setToolTipText("Has click para borrar.");
        jButtonBorrarEmisoresDeTarjetas.setBorder(null);
        jButtonBorrarEmisoresDeTarjetas.setBorderPainted(false);
        jButtonBorrarEmisoresDeTarjetas.setContentAreaFilled(false);
        jButtonBorrarEmisoresDeTarjetas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonBorrarEmisoresDeTarjetas.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarEmisoresDeTarjetas.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarEmisoresDeTarjetas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonBorrarEmisoresDeTarjetasActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonBorrarEmisoresDeTarjetas, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 176, -1, -1));
        ...
        jLabelTituloVentana.setText("Registro de emisores de tarjetas");
...
// se crea un objeto de la clase utilizada    
    public void crearObjEmisoresDeTarjetas(){
     
        _objEmisoresDeTarjetas = new EmisoresDeTarjetas();
        _objEmisoresDeTarjetas.setIuEmisorDeTarjeta(Integer.parseInt(jTextFieldIuEmisoresDeTarjetas.getText()));
        _objEmisoresDeTarjetas.setDescrEmisor(jTextFieldDescrEmisoresDeTarjetas.getText());
     }
...
// limpia los jtextfield usados
    public void limpiarCampos(){
        ...
        jTextFieldIuEmisoresDeTarjetas.setText("AUTOMATICO");
        jTextFieldDescrEmisoresDeTarjetas.setText(""); 
        }
...
//se crean las opciones del menu
        JPopupMenu jPopupMenuTableHEDT = new JPopupMenu();
        JMenuItem jMenuItemEliminarEmisoresDeTarjetas = new JMenuItem("Eliminar"); // cambiar x ico 
        JMenuItem jMenuItemModificarEmisoresDeTarjetas = new JMenuItem("Modificar");
...
// se generan las acciones de cada opcion
        jMenuItemEliminarEmisoresDeTarjetas.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarEmisoresDeTarjetas.setEnabled(false);
            jButtonEditarEmisoresDeTarjetas.setEnabled(false);
            jTextFieldDescrEmisoresDeTarjetas.setEditable(false); 
            jButtonBorrarEmisoresDeTarjetas.setEnabled(true);
             }
         });
         
        jMenuItemModificarEmisoresDeTarjetas.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarEmisoresDeTarjetas.setEnabled(false);
            jButtonBorrarEmisoresDeTarjetas.setEnabled(false);
            jButtonEditarEmisoresDeTarjetas.setEnabled(true);
            
        }
        });
             
        jMenuItemUltimosAgregados.addActionListener((ActionEvent e) -> {
            _administradorEmisoresDeTarjetas.ordenarTabla(jMenuItemUltimosAgregados.getText());
            jTableEmisoresDeTarjetas.setModel( _administradorEmisoresDeTarjetas.cargarJTabla());
        });
                
        jMenuItemAlfabeticos.addActionListener((ActionEvent e) -> {
            _administradorEmisoresDeTarjetas.ordenarTabla(jMenuItemAlfabeticos.getText());
            jTableEmisoresDeTarjetas.setModel( _administradorEmisoresDeTarjetas.cargarJTabla());
        });
                                
        jMenuItemPrimerosAgregados.addActionListener((ActionEvent e) -> {
            _administradorEmisoresDeTarjetas.ordenarTabla(jMenuItemPrimerosAgregados.getText());
            jTableEmisoresDeTarjetas.setModel( _administradorEmisoresDeTarjetas.cargarJTabla());
        });
// se construye el menu completo y se le asigna si jTable
        jPopupMenuTableHEDT.add(jMenuItemEliminarEmisoresDeTarjetas);
        jPopupMenuTableHEDT.add(jMenuItemModificarEmisoresDeTarjetas);
        jPopupMenuTableHEDT.add(jMenuOrdenar);
        jTableEmisoresDeTarjetas.setComponentPopupMenu(jPopupMenuTableHEDT);  
     }
...
// se obtiene el modelo y se verifica que se haya seleccionado un item   
        modeloTablaEDT = jTableEmisoresDeTarjetas.getModel();
        int auxSeleccion = jTableEmisoresDeTarjetas.getSelectedRow();
        if (auxSeleccion != -1) {
// se cargan los campos con los valores selcionados
            jTableEmisoresDeTarjetas.setEnabled(true);
            iuEmisoresDeTarjetas =  (String)modeloTablaEDT.getValueAt(jTableEmisoresDeTarjetas.getSelectedRow(), 0);
            jTextFieldIuEmisoresDeTarjetas.setText(iuEmisoresDeTarjetas);
            jTextFieldDescrEmisoresDeTarjetas.setText((String)modeloTablaEDT.getValueAt(jTableEmisoresDeTarjetas.getSelectedRow(), 1));
            return auxSeleccion;
            
        }else {
// si no selecciona mensaje error  
            jTableEmisoresDeTarjetas.setEnabled(false);
...
// valida datos y agrega a tabla tipocaja un registro 
    private void jButtonAgregarEmisoresDeTarjetasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarEmisoresDeTarjetasActionPerformed
        ...
        jTextFieldDescrEmisoresDeTarjetas.setEditable(false);
    }//GEN-LAST:event_jButtonAgregarEmisoresDeTarjetasActionPerformed

//valida datos y edita un registro en tabla EmisoresDeTarjetas
    private void jButtonEditarEmisoresDeTarjetasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarEmisoresDeTarjetasActionPerformed
        ...
        jButtonTraerPanelBuscar.setEnabled(false);
        jTextFieldDescrEmisoresDeTarjetas.setEditable(false);
    }//GEN-LAST:event_jButtonEditarEmisoresDeTarjetasActionPerformed

//valida datos y borra un registro en tabla EmisoresDeTarjetas 
    private void jButtonBorrarEmisoresDeTarjetasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarEmisoresDeTarjetasActionPerformed
        ...
        jButtonTraerPanelBuscar.setEnabled(false);
        jTextFieldDescrEmisoresDeTarjetas.setEditable(false);
    }//GEN-LAST:event_jButtonBorrarEmisoresDeTarjetasActionPerformed

// con cada tecleo valida los datos y elimina los no correctos
    private void jTextFieldBuscarEmisoresDeTarjetasKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscarEmisoresDeTarjetasKeyReleased
    ...
    try {
        ...
        if(auxValidar==false){
            ...
            evt.consume();
            jTableEmisoresDeTarjetas.setModel(_administradorEmisoresDeTarjetas.buscarEnTabla(jTextFieldBuscarEmisoresDeTarjetas.getText()));
    ...
    }//GEN-LAST:event_jTextFieldBuscarEmisoresDeTarjetasKeyReleased
...
//esconde el panel y habilita los obj en pantalla
    private void jButtonCancelarValidarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarValidarCambiosActionPerformed
        ...
        limpiarCampos();
        jPanelMensajeValidarABM.setBounds(-260, 100, 250, 100);
        jButtonAgregarEmisoresDeTarjetas.setEnabled(true);
        jButtonEditarEmisoresDeTarjetas.setEnabled(false);
        jButtonBorrarEmisoresDeTarjetas.setEnabled(false);
        jButtonTraerPanelBuscar.setEnabled(true);
        jTextFieldDescrEmisoresDeTarjetas.setEditable(true);
        jTextFieldDescrEmisoresDeTarjetas.setBorder(null);
...
// se validan los datos
                aux2 = jTextFieldDescrEmisoresDeTarjetas.getText();
                auxValidar2 = Administrador.validarCamposTextos(aux2,"[a-zA-Z]||[\\s]||[\\d]");
// si es correcto se crea el objeto de la clase usada
                if(auxValidar2==true){

                    jTextFieldDescrEmisoresDeTarjetas.setBorder(new LineBorder(Color.green));
                    _objEmisoresDeTarjetas = new EmisoresDeTarjetas();
                    _objEmisoresDeTarjetas.setDescrEmisor(jTextFieldDescrEmisoresDeTarjetas.getText());
// se avisa en caso de estar apagada la db y si no se agrega un item a la db
    try {
                    if(_administradorEmisoresDeTarjetas.insertarTablaEmisoresDeTajetas(_objEmisoresDeTarjetas)==true){
...
// en caso de no ser validos los datos se avisa al usuario
                    ...
                    jTextFieldDescrEmisoresDeTarjetas.setBorder(new LineBorder(Color.red));
...
// se repite el mismo codigo solo que se edita un item de la db 
            case 2:
                ...
                if(auxValidar2==true){
                    ...
                    jTextFieldDescrEmisoresDeTarjetas.setBorder(new LineBorder(Color.green));
                    crearObjEmisoresDeTarjetas();
    try {
                if(_administradorEmisoresDeTarjetas.actualizarTablaEmisoresDeTajetas(_objEmisoresDeTarjetas)==true){
...
// se repite el mismo codigo solo que se borra un item de la db         
            case 3:
                ...
                if(auxValidar2==true){
                    ...
                    crearObjEmisoresDeTarjetas();
    try {
                if(_administradorEmisoresDeTarjetas.eliminarTablaEmisoresDeTarjetas(_objEmisoresDeTarjetas)==true){   
...
// se acomoda los objetos del frame para continuar trabajando. 
    ...
    private javax.swing.JButton jButtonAgregarEmisoresDeTarjetas;
    private javax.swing.JButton jButtonBorrarEmisoresDeTarjetas;
    private javax.swing.JButton jButtonCancelar;
    private javax.swing.JButton jButtonCancelarValidarCambios;
    private javax.swing.JButton jButtonCerrar;
    private javax.swing.JButton jButtonEditarEmisoresDeTarjetas;
    ...
    private javax.swing.JLabel jLabelTituloBuscarEmisoresDeTarjetas;
    private javax.swing.JLabel jLabelTituloDescrEmisoresDeTarjetas;
    private javax.swing.JLabel jLabelTituloIuEmisoresDeTarjetas;
    ...
    private javax.swing.JSeparator jSeparatorBuscarEmisoresDeTarjetas;
    private javax.swing.JSeparator jSeparatorDescrEmisoresDeTarjetas;
    private javax.swing.JSeparator jSeparatorIuEmisoresDeTarjetas;
    private javax.swing.JTable jTableEmisoresDeTarjetas;
    private javax.swing.JTextField jTextFieldBuscarEmisoresDeTarjetas;
    private javax.swing.JTextField jTextFieldDescrEmisoresDeTarjetas;
    private javax.swing.JTextField jTextFieldIuEmisoresDeTarjetas;
