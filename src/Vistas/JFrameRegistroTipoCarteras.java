/*
* este JFrame registra (agrega, borra, edita, busca y filtra) todos los tipos de carteras
 */
package Vistas;
...
public class JFrameRegistroTipoCarteras extends javax.swing.JFrame {
// atributos y variables    
    private final AdministradorTipoCarteras _administradorTipoCarteras;
    private TipoCartera _objTipoCartera;
    private TableModel modeloTablaTC;
    private String iuTipoCartera;
    private int auxAbm;
    
    public JFrameRegistroTipoCarteras() {
        initComponents();
// se personaliza las fuentes de letra de los objetos grafico
        ...
        jLabelTituloIuTipoCartera.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldIuTipoCartera.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 7));
        jLabelTituloDescrTipoCarteras.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldDescrTipoCarteras.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
        jLabelTituloBuscarTipoCartera.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldBuscarTipoCartera.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
...
// se personaliza el jTable    
        jTableTipoCartera.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 6));
        JTableHeader auxJTableHeader;
        auxJTableHeader = jTableTipoCartera.getTableHeader();
        auxJTableHeader.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 7));
// se instancia la clase AdministradorTipoCarteras y se inicializa el menu del jTable
        _administradorTipoCarteras = new AdministradorTipoCarteras();
        popupMenuJTable();
        
        jTextFieldIuTipoCartera.setEditable(false);
        jButtonEditarTipoCartera.setEnabled(false);
        jButtonBorrarTipoCartera.setEnabled(false);
    }   
    ...
    private void initComponents() {
        ...
        jSeparatorBuscarTipoCartera = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTableTipoCartera = new javax.swing.JTable();
        jLabelTituloBuscarTipoCartera = new javax.swing.JLabel();
        jTextFieldBuscarTipoCartera = new javax.swing.JTextField();
        jButtonTraerPanelCuerpo = new javax.swing.JButton();
        jLabelFondoVentanaBuscar = new javax.swing.JLabel();
        jPanelCuerpo = new javax.swing.JPanel();
        jLabelTituloDescrTipoCarteras = new javax.swing.JLabel();
        jTextFieldDescrTipoCarteras = new javax.swing.JTextField();
        jSeparatorDescrTipoCartera = new javax.swing.JSeparator();
        jSeparatorIuTipoCartera = new javax.swing.JSeparator();
        jLabelTituloIuTipoCartera = new javax.swing.JLabel();
        jTextFieldIuTipoCartera = new javax.swing.JTextField();
        jButtonAgregarTipoCartera = new javax.swing.JButton();
        jButtonEditarTipoCartera = new javax.swing.JButton();
        jButtonBorrarTipoCartera = new javax.swing.JButton();
        ...
        jSeparatorBuscarTipoCartera.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorBuscarTipoCartera.setForeground(new java.awt.Color(0, 0, 0));
        jPanelVentanaBuscar.add(jSeparatorBuscarTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 55, 100, 2));
        ...
        jTableTipoCartera.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jTableTipoCartera.setToolTipText("Has click derecho para opciones.");
        jTableTipoCartera.setAutoscrolls(false);
        jTableTipoCartera.setFocusable(false);
        jTableTipoCartera.setMaximumSize(new java.awt.Dimension(480, 250));
        jTableTipoCartera.setMinimumSize(new java.awt.Dimension(480, 250));
        jTableTipoCartera.setPreferredSize(new java.awt.Dimension(480, 250));
        jTableTipoCartera.setSelectionBackground(new java.awt.Color(73, 73, 73));
        jTableTipoCartera.setSelectionForeground(new java.awt.Color(245, 245, 245));
        jTableTipoCartera.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jTableTipoCartera);

        jPanelVentanaBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 480, 146));

        jLabelTituloBuscarTipoCartera.setText("Parametro de busqueda:");
        jPanelVentanaBuscar.add(jLabelTituloBuscarTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 10, -1, 25));

        jTextFieldBuscarTipoCartera.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldBuscarTipoCartera.setToolTipText("ingresa parametros de busqueda. Ej: asug");
        jTextFieldBuscarTipoCartera.setBorder(null);
        jTextFieldBuscarTipoCartera.setDisabledTextColor(new java.awt.Color(194, 4, 48));
        jTextFieldBuscarTipoCartera.setOpaque(false);
        jTextFieldBuscarTipoCartera.setSelectionColor(new java.awt.Color(73, 73, 73));
        jTextFieldBuscarTipoCartera.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBuscarTipoCarteraKeyReleased(evt);
            }
        });
        jPanelVentanaBuscar.add(jTextFieldBuscarTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 35, 100, 20));
        ...
        jLabelTituloDescrTipoCarteras.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloDescrTipoCarteras.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloDescrTipoCarteras.setText("Tipo de cartera:");
        jLabelTituloDescrTipoCarteras.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloDescrTipoCarteras, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 98, -1, 25));

        jTextFieldDescrTipoCarteras.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldDescrTipoCarteras.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldDescrTipoCarteras.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldDescrTipoCarteras.setToolTipText("Ingrese solo texto. Ej.: asegurado");
        jTextFieldDescrTipoCarteras.setBorder(null);
        jTextFieldDescrTipoCarteras.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrTipoCarteras.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrTipoCarteras.setOpaque(false);
        jTextFieldDescrTipoCarteras.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrTipoCarteras.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldDescrTipoCarteras, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 118, 200, 20));

        jSeparatorDescrTipoCartera.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrTipoCartera.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrTipoCartera.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorDescrTipoCartera.setOpaque(true);
        jPanelCuerpo.add(jSeparatorDescrTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 138, 200, -1));

        jSeparatorIuTipoCartera.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorIuTipoCartera.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorIuTipoCartera.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorIuTipoCartera.setOpaque(true);
        jPanelCuerpo.add(jSeparatorIuTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 66, 100, -1));

        jLabelTituloIuTipoCartera.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloIuTipoCartera.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloIuTipoCartera.setText("Codigo identificacion:");
        jLabelTituloIuTipoCartera.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloIuTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 25, -1, 25));

        jTextFieldIuTipoCartera.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldIuTipoCartera.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldIuTipoCartera.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldIuTipoCartera.setText("AUTOMATICO");
        jTextFieldIuTipoCartera.setToolTipText("");
        jTextFieldIuTipoCartera.setBorder(null);
        jTextFieldIuTipoCartera.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldIuTipoCartera.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldIuTipoCartera.setOpaque(false);
        jTextFieldIuTipoCartera.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldIuTipoCartera.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldIuTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 45, 100, 20));

        jButtonAgregarTipoCartera.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOff.png"))); // NOI18N
        jButtonAgregarTipoCartera.setToolTipText("Has click para agregar.");
        jButtonAgregarTipoCartera.setBorder(null);
        jButtonAgregarTipoCartera.setBorderPainted(false);
        jButtonAgregarTipoCartera.setContentAreaFilled(false);
        jButtonAgregarTipoCartera.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonAgregarTipoCartera.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarTipoCartera.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarTipoCartera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAgregarTipoCarteraActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonAgregarTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 176, -1, -1));

        jButtonEditarTipoCartera.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOff.png"))); // NOI18N
        jButtonEditarTipoCartera.setToolTipText("Has click para editar.");
        jButtonEditarTipoCartera.setBorder(null);
        jButtonEditarTipoCartera.setBorderPainted(false);
        jButtonEditarTipoCartera.setContentAreaFilled(false);
        jButtonEditarTipoCartera.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonEditarTipoCartera.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarTipoCartera.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarTipoCartera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEditarTipoCarteraActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonEditarTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 176, -1, -1));

        jButtonBorrarTipoCartera.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOff.png"))); // NOI18N
        jButtonBorrarTipoCartera.setToolTipText("Has click para borrar.");
        jButtonBorrarTipoCartera.setBorder(null);
        jButtonBorrarTipoCartera.setBorderPainted(false);
        jButtonBorrarTipoCartera.setContentAreaFilled(false);
        jButtonBorrarTipoCartera.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonBorrarTipoCartera.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarTipoCartera.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarTipoCartera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonBorrarTipoCarteraActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonBorrarTipoCartera, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 176, -1, -1));
        ...
        jLabelTituloVentana.setText("Registro de tipos de cartera");
...
// se crea un objeto de la clase utilizada    
    public void crearObjTipoPagos(){
        ...
        _objTipoCartera = new TipoCartera();
        _objTipoCartera.setIuTipoCartera(Integer.parseInt(jTextFieldIuTipoCartera.getText()));
        _objTipoCartera.setDescrTipoCartera(jTextFieldDescrTipoCarteras.getText());
     }
...
// limpia los jtextfield usados
    public void limpiarCampos(){
        ...
        jTextFieldIuTipoCartera.setText("AUTOMATICO");
        jTextFieldDescrTipoCarteras.setText(""); 
        }
...
//se crean las opciones del menu
        ...
        JMenuItem jMenuItemEliminarTipoCartera = new JMenuItem("Eliminar"); // cambiar x ico 
        JMenuItem jMenuItemModificarTipoCartera = new JMenuItem("Modificar");
...
// se generan las acciones de cada opcion
        jMenuItemEliminarTipoCartera.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarTipoCartera.setEnabled(false);
            jButtonEditarTipoCartera.setEnabled(false);
            jTextFieldDescrTipoCarteras.setEditable(false);  
            jButtonBorrarTipoCartera.setEnabled(true);
             }
         });
         
        jMenuItemModificarTipoCartera.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarTipoCartera.setEnabled(false);
            jButtonBorrarTipoCartera.setEnabled(false);
            jButtonEditarTipoCartera.setEnabled(true);
        }
        });
             
        jMenuItemUltimosAgregados.addActionListener((ActionEvent e) -> {
            _administradorTipoCarteras.ordenarTabla(jMenuItemUltimosAgregados.getText());
            jTableTipoCartera.setModel( _administradorTipoCarteras.cargarJTabla());
        });
                
        jMenuItemAlfabeticos.addActionListener((ActionEvent e) -> {
            _administradorTipoCarteras.ordenarTabla(jMenuItemAlfabeticos.getText());
            jTableTipoCartera.setModel( _administradorTipoCarteras.cargarJTabla());
        });
                                
        jMenuItemPrimerosAgregados.addActionListener((ActionEvent e) -> {
            _administradorTipoCarteras.ordenarTabla(jMenuItemPrimerosAgregados.getText());
            jTableTipoCartera.setModel( _administradorTipoCarteras.cargarJTabla());
        });
// se construye el menu completo y se le asigna si jTable
        jPopupMenuTableHTC.add(jMenuItemEliminarTipoCartera);
        jPopupMenuTableHTC.add(jMenuItemModificarTipoCartera);
        jPopupMenuTableHTC.add(jMenuOrdenar);
        jTableTipoCartera.setComponentPopupMenu(jPopupMenuTableHTC);  
     }
...
// se obtiene el modelo y se verifica que se haya seleccionado un item   
        modeloTablaTC = jTableTipoCartera.getModel();
        int auxSeleccion = jTableTipoCartera.getSelectedRow();
        if (auxSeleccion != -1) {
            jTableTipoCartera.setEnabled(true);
// se cargan los campos con los valores selcionados
            iuTipoCartera =  (String)modeloTablaTC.getValueAt(jTableTipoCartera.getSelectedRow(), 0);
            jTextFieldIuTipoCartera.setText(iuTipoCartera);
            jTextFieldDescrTipoCarteras.setText((String)modeloTablaTC.getValueAt(jTableTipoCartera.getSelectedRow(), 1));
            return auxSeleccion;
            
        }else {
// si no selecciona mensaje error   
            jTableTipoCartera.setEnabled(false);
...
// valida datos y agrega a tabla TipoCarteras un registro 
    private void jButtonAgregarTipoCarteraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarTipoCarteraActionPerformed
        ...
        jTextFieldDescrTipoCarteras.setEditable(false);
    }//GEN-LAST:event_jButtonAgregarTipoCarteraActionPerformed

//valida datos y edita un registro en tabla TipoCarteras
    private void jButtonEditarTipoCarteraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarTipoCarteraActionPerformed
        ...
        jButtonTraerPanelBuscar.setEnabled(false);
        jTextFieldDescrTipoCarteras.setEditable(false);
    }//GEN-LAST:event_jButtonEditarTipoCarteraActionPerformed

//valida datos y borra un registro en tabla TipoCarteras 
    private void jButtonBorrarTipoCarteraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarTipoCarteraActionPerformed
        ...
        jButtonTraerPanelBuscar.setEnabled(false);
        jTextFieldDescrTipoCarteras.setEditable(false);
    }//GEN-LAST:event_jButtonBorrarTipoCarteraActionPerformed

// con cada tecleo valida los datos y elimina los no correctos
    private void jTextFieldBuscarTipoCarteraKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscarTipoCarteraKeyReleased
    ...
    try {
        ...
        if(auxValidar==false){
            ...
            evt.consume();
            jTableTipoCartera.setModel(_administradorTipoCarteras.buscarEnTabla(jTextFieldBuscarTipoCartera.getText()));
    ...
    }//GEN-LAST:event_jTextFieldBuscarTipoCarteraKeyReleased
...
//esconde el panel y habilita los obj en pantalla
    private void jButtonCancelarValidarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarValidarCambiosActionPerformed
        ...
        limpiarCampos();
        jPanelMensajeValidarABM.setBounds(-260, 100, 250, 100);
        jButtonAgregarTipoCartera.setEnabled(true);
        jButtonEditarTipoCartera.setEnabled(false);
        jButtonBorrarTipoCartera.setEnabled(false);
        jButtonTraerPanelBuscar.setEnabled(true);
        jTextFieldDescrTipoCarteras.setEditable(true);
        jTextFieldDescrTipoCarteras.setBorder(null);
...
// en caso de no ser validos los datos se avisa al usuario
                    ...
                    jTextFieldDescrTipoCarteras.setBorder(new LineBorder(Color.red));
...
// se repite el mismo codigo solo que se edita un item de la db 
            case 2:
                ...
                if(auxValidar2==true){
                    ...
                    crearObjTipoPagos();
    try {
                if(_administradorTipoCarteras.actualizarTablaTiposCarteras(_objTipoCartera)==true){
...
// se repite el mismo codigo solo que se borra un item de la db         
            case 3:
                ...
                if(auxValidar2==true){
                    ...
                    crearObjTipoPagos();
    try {
                if(_administradorTipoCarteras.eliminarTablaTiposCarteras(_objTipoCartera)==true){   
...
// se acomoda los objetos del frame para continuar trabajando. 
    ...
    private javax.swing.JButton jButtonAgregarTipoCartera;
    private javax.swing.JButton jButtonBorrarTipoCartera;
    private javax.swing.JButton jButtonCancelar;
    private javax.swing.JButton jButtonCancelarValidarCambios;
    private javax.swing.JButton jButtonCerrar;
    private javax.swing.JButton jButtonEditarTipoCartera;
    ...
    private javax.swing.JLabel jLabelTituloBuscarTipoCartera;
    private javax.swing.JLabel jLabelTituloDescrTipoCarteras;
    private javax.swing.JLabel jLabelTituloIuTipoCartera;
    ...
    private javax.swing.JSeparator jSeparatorBuscarTipoCartera;
    private javax.swing.JSeparator jSeparatorDescrTipoCartera;
    private javax.swing.JSeparator jSeparatorIuTipoCartera;
    private javax.swing.JTable jTableTipoCartera;
    private javax.swing.JTextField jTextFieldBuscarTipoCartera;
    private javax.swing.JTextField jTextFieldDescrTipoCarteras;
    private javax.swing.JTextField jTextFieldIuTipoCartera;
