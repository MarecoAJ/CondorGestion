/*
* este JFrame registra (agrega, borra, edita, busca y filtra) todos los tipos de pagos
 */
package Vistas;
...
public class JFrameRegistroTipoPagos extends javax.swing.JFrame {
// atributos y variables    
    private final AdministradorTipoPagos _administradorTipoPagos;
    private TipoPagos _objTipoPago;
    private TableModel modeloTablaTP;
    private String iuTipoPago;
    private int auxAbm;
    
    public JFrameRegistroTipoPagos() {
        initComponents();
// se personaliza las fuentes de letra de los objetos grafico
        ...
        jTextFieldIuTipoPago.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 7));
        jLabelTituloDescrTipoPagos.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldDescrTipoPagos.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
        jLabelTituloBuscarTipoPago.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldBuscarTipoPago.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
...
// se personaliza el jTable    
        jTableTipoPago.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 6));
        JTableHeader auxJTableHeader;
        auxJTableHeader = jTableTipoPago.getTableHeader();
...
// se instancia la clase AdministradorTipoPagos y se inicializa el menu del jTable
        ...
        jButtonEditarTipoPago.setEnabled(false);
        jButtonBorrarTipoPago.setEnabled(false);
    }   
    ...
    private void initComponents() {
        ...
        jSeparatorBuscarTipoPago = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTableTipoPago = new javax.swing.JTable();
        jLabelTituloBuscarTipoPago = new javax.swing.JLabel();
        jTextFieldBuscarTipoPago = new javax.swing.JTextField();
        jButtonTraerPanelCuerpo = new javax.swing.JButton();
        jLabelFondoVentanaBuscar = new javax.swing.JLabel();
        jPanelCuerpo = new javax.swing.JPanel();
        jLabelTituloDescrTipoPagos = new javax.swing.JLabel();
        jTextFieldDescrTipoPagos = new javax.swing.JTextField();
        jSeparatorDescrTipoPago = new javax.swing.JSeparator();
        ...
        jButtonAgregarTipoPago = new javax.swing.JButton();
        jButtonEditarTipoPago = new javax.swing.JButton();
        jButtonBorrarTipoPago = new javax.swing.JButton();
        ...
        jSeparatorBuscarTipoPago.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorBuscarTipoPago.setForeground(new java.awt.Color(0, 0, 0));
        jPanelVentanaBuscar.add(jSeparatorBuscarTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 55, 100, 2));
        ...
        jTableTipoPago.setToolTipText("Has click derecho para opciones.");
        jTableTipoPago.setAutoscrolls(false);
        jTableTipoPago.setFocusable(false);
        jTableTipoPago.setMaximumSize(new java.awt.Dimension(480, 250));
        jTableTipoPago.setMinimumSize(new java.awt.Dimension(480, 250));
        jTableTipoPago.setPreferredSize(new java.awt.Dimension(480, 250));
        jTableTipoPago.setSelectionBackground(new java.awt.Color(73, 73, 73));
        jTableTipoPago.setSelectionForeground(new java.awt.Color(245, 245, 245));
        jTableTipoPago.getTableHeader().setReorderingAllowed(false);
        ...
        jLabelTituloBuscarTipoPago.setText("Parametro de busqueda:");
        jPanelVentanaBuscar.add(jLabelTituloBuscarTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 10, -1, 25));

        jTextFieldBuscarTipoPago.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldBuscarTipoPago.setToolTipText("ingresa parametros de busqueda. Ej: efec");
        jTextFieldBuscarTipoPago.setBorder(null);
        jTextFieldBuscarTipoPago.setDisabledTextColor(new java.awt.Color(194, 4, 48));
        jTextFieldBuscarTipoPago.setOpaque(false);
        jTextFieldBuscarTipoPago.setSelectionColor(new java.awt.Color(73, 73, 73));
        jTextFieldBuscarTipoPago.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBuscarTipoPagoKeyReleased(evt);
            }
        });
        jPanelVentanaBuscar.add(jTextFieldBuscarTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 35, 100, 20));
        ...
        jLabelTituloDescrTipoPagos.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloDescrTipoPagos.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloDescrTipoPagos.setText("Tipo de pago:");
        jLabelTituloDescrTipoPagos.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloDescrTipoPagos, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 98, -1, 25));

        jTextFieldDescrTipoPagos.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldDescrTipoPagos.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldDescrTipoPagos.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldDescrTipoPagos.setToolTipText("Ingrese solo texto. Ej.: efectivo");
        jTextFieldDescrTipoPagos.setBorder(null);
        jTextFieldDescrTipoPagos.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrTipoPagos.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrTipoPagos.setOpaque(false);
        jTextFieldDescrTipoPagos.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrTipoPagos.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldDescrTipoPagos, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 118, 200, 20));

        jSeparatorDescrTipoPago.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrTipoPago.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrTipoPago.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorDescrTipoPago.setOpaque(true);
        jPanelCuerpo.add(jSeparatorDescrTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 138, 200, -1));
        ...
        jPanelCuerpo.add(jSeparatorIuTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 66, 100, -1));
        ...
        jLabelTituloIuTipoPago.setText("Codigo identificacion:");
        jLabelTituloIuTipoPago.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloIuTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 25, -1, 25));
        ...
        jTextFieldIuTipoPago.setText("AUTOMATICO");
        jTextFieldIuTipoPago.setToolTipText("");
        ...
        jPanelCuerpo.add(jTextFieldIuTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 45, 100, 20));

        jButtonAgregarTipoPago.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOff.png"))); // NOI18N
        jButtonAgregarTipoPago.setToolTipText("Has click para agregar.");
        jButtonAgregarTipoPago.setBorder(null);
        jButtonAgregarTipoPago.setBorderPainted(false);
        jButtonAgregarTipoPago.setContentAreaFilled(false);
        jButtonAgregarTipoPago.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonAgregarTipoPago.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarTipoPago.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarTipoPago.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAgregarTipoPagoActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonAgregarTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 176, -1, -1));

        jButtonEditarTipoPago.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOff.png"))); // NOI18N
        jButtonEditarTipoPago.setToolTipText("Has click para editar.");
        jButtonEditarTipoPago.setBorder(null);
        jButtonEditarTipoPago.setBorderPainted(false);
        jButtonEditarTipoPago.setContentAreaFilled(false);
        jButtonEditarTipoPago.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonEditarTipoPago.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarTipoPago.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarTipoPago.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEditarTipoPagoActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonEditarTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 176, -1, -1));

        jButtonBorrarTipoPago.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOff.png"))); // NOI18N
        jButtonBorrarTipoPago.setToolTipText("Has click para borrar.");
        jButtonBorrarTipoPago.setBorder(null);
        jButtonBorrarTipoPago.setBorderPainted(false);
        jButtonBorrarTipoPago.setContentAreaFilled(false);
        jButtonBorrarTipoPago.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonBorrarTipoPago.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarTipoPago.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarTipoPago.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonBorrarTipoPagoActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonBorrarTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 176, -1, -1));
        ...
        jLabelTituloVentana.setText("Registro de tipos de pago");
...
// se crea un objeto de la clase utilizada    
    public void crearObjTipoPagos(){
        ...
        _objTipoPago = new TipoPagos();
        _objTipoPago.setIuTiposPagos(Integer.parseInt(jTextFieldIuTipoPago.getText()));
        _objTipoPago.setDescrTiposPagos(jTextFieldDescrTipoPagos.getText());
     }
...
// limpia los jtextfield usados
    public void limpiarCampos(){
        ...
        jTextFieldIuTipoPago.setText("AUTOMATICO");
        jTextFieldDescrTipoPagos.setText(""); 
        }
...
//se crean las opciones del menu
        JPopupMenu jPopupMenuTableHTP = new JPopupMenu();
        JMenuItem jMenuItemEliminarTipoPago = new JMenuItem("Eliminar"); // cambiar x ico 
        JMenuItem jMenuItemModificarTipoPago = new JMenuItem("Modificar");
...
// se generan las acciones de cada opcion
        jMenuItemEliminarTipoPago.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarTipoPago.setEnabled(false);
            jButtonEditarTipoPago.setEnabled(false);
            jTextFieldDescrTipoPagos.setEditable(false);  
            jButtonBorrarTipoPago.setEnabled(true);
             }
         });
         
        jMenuItemModificarTipoPago.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarTipoPago.setEnabled(false);
            jButtonBorrarTipoPago.setEnabled(false);   
            jButtonEditarTipoPago.setEnabled(true);
        }
        });
             
        jMenuItemUltimosAgregados.addActionListener((ActionEvent e) -> {
            _administradorTipoPagos.ordenarTabla(jMenuItemUltimosAgregados.getText());
            jTableTipoPago.setModel( _administradorTipoPagos.cargarJTabla());
        });
                
        jMenuItemAlfabeticos.addActionListener((ActionEvent e) -> {
            _administradorTipoPagos.ordenarTabla(jMenuItemAlfabeticos.getText());
            jTableTipoPago.setModel( _administradorTipoPagos.cargarJTabla());
        });
                                
        jMenuItemPrimerosAgregados.addActionListener((ActionEvent e) -> {
            _administradorTipoPagos.ordenarTabla(jMenuItemPrimerosAgregados.getText());
            jTableTipoPago.setModel( _administradorTipoPagos.cargarJTabla());
        });
// se construye el menu completo y se le asigna si jTable
        jPopupMenuTableHTP.add(jMenuItemEliminarTipoPago);
        jPopupMenuTableHTP.add(jMenuItemModificarTipoPago);
        jPopupMenuTableHTP.add(jMenuOrdenar);
        jTableTipoPago.setComponentPopupMenu(jPopupMenuTableHTP);  
     }
...
// se obtiene el modelo y se verifica que se haya seleccionado un item   
        modeloTablaTP = jTableTipoPago.getModel();
        int auxSeleccion = jTableTipoPago.getSelectedRow();
        if (auxSeleccion != -1) {
            jTableTipoPago.setEnabled(true);
// se cargan los campos con los valores selcionados
            iuTipoPago =  (String)modeloTablaTP.getValueAt(jTableTipoPago.getSelectedRow(), 0);
            jTextFieldIuTipoPago.setText(iuTipoPago);
            jTextFieldDescrTipoPagos.setText((String)modeloTablaTP.getValueAt(jTableTipoPago.getSelectedRow(), 1));
            return auxSeleccion;
            
        }else {
// si no selecciona mensaje error   
            jTableTipoPago.setEnabled(false);
...
// valida datos y agrega a tabla TipoPagos un registro 
    private void jButtonAgregarTipoPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarTipoPagoActionPerformed
        ...
        jTextFieldDescrTipoPagos.setEditable(false);
    }//GEN-LAST:event_jButtonAgregarTipoPagoActionPerformed

//valida datos y edita un registro en tabla TipoPagos
    private void jButtonEditarTipoPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarTipoPagoActionPerformed
        ...
        jButtonTraerPanelBuscar.setEnabled(false);
        jTextFieldDescrTipoPagos.setEditable(false);
    }//GEN-LAST:event_jButtonEditarTipoPagoActionPerformed

//valida datos y borra un registro en tabla TipoPagos 
    private void jButtonBorrarTipoPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarTipoPagoActionPerformed
        ...
        jButtonTraerPanelBuscar.setEnabled(false);
        jTextFieldDescrTipoPagos.setEditable(false);
    }//GEN-LAST:event_jButtonBorrarTipoPagoActionPerformed

// con cada tecleo valida los datos y elimina los no correctos
    private void jTextFieldBuscarTipoPagoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscarTipoPagoKeyReleased
    ...
    try {
        ...
        if(auxValidar==false){
            ...
            evt.consume();
            jTableTipoPago.setModel(_administradorTipoPagos.buscarEnTabla(jTextFieldBuscarTipoPago.getText()));
    ...
    }//GEN-LAST:event_jTextFieldBuscarTipoPagoKeyReleased
...
//esconde el panel y habilita los obj en pantalla
    private void jButtonCancelarValidarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarValidarCambiosActionPerformed
        ...
        limpiarCampos();
        jPanelMensajeValidarABM.setBounds(-260, 100, 250, 100);
        jButtonAgregarTipoPago.setEnabled(true);
        jButtonEditarTipoPago.setEnabled(false);
        jButtonBorrarTipoPago.setEnabled(false);
        jButtonTraerPanelBuscar.setEnabled(true);
        jTextFieldDescrTipoPagos.setEditable(true);
        jTextFieldDescrTipoPagos.setBorder(null);
...
// en caso de no ser validos los datos se avisa al usuario
                    ...
                    jTextFieldDescrTipoPagos.setBorder(new LineBorder(Color.red));
...
// se repite el mismo codigo solo que se edita un item de la db 
            case 2:
                ...
                if(auxValidar2==true){
                    ...
                    crearObjTipoPagos();
    try {
                if(_administradorTipoPagos.actualizarTablaTiposPagos(_objTipoPago)==true){
...
// se repite el mismo codigo solo que se borra un item de la db         
            case 3:
                ...
                if(auxValidar2==true){
                    ...
                    crearObjTipoPagos();
    try {
                if(_administradorTipoPagos.eliminarTablaTiposPagos(_objTipoPago)==true){   
...
// se acomoda los objetos del frame para continuar trabajando. 
    ...
    private javax.swing.JButton jButtonAgregarTipoPago;
    private javax.swing.JButton jButtonBorrarTipoPago;
    private javax.swing.JButton jButtonCancelar;
    private javax.swing.JButton jButtonCancelarValidarCambios;
    private javax.swing.JButton jButtonCerrar;
    private javax.swing.JButton jButtonEditarTipoPago;
    ...
    private javax.swing.JLabel jLabelTituloBuscarTipoPago;
    private javax.swing.JLabel jLabelTituloDescrTipoPagos;
    ...
    private javax.swing.JSeparator jSeparatorBuscarTipoPago;
    private javax.swing.JSeparator jSeparatorDescrTipoPago;
    private javax.swing.JSeparator jSeparatorIuTipoPago;
    private javax.swing.JTable jTableTipoPago;
    private javax.swing.JTextField jTextFieldBuscarTipoPago;
    private javax.swing.JTextField jTextFieldDescrTipoPagos;
