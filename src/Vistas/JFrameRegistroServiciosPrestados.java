...
public class JFrameRegistroServiciosPrestados extends javax.swing.JFrame {
// atributos y variables    
    private final AdministradorServiciosPrestados _administradorServiciosPrestados;
    private ServiciosPrestados _objServiciosPrestados;
    private TableModel modeloTablaSP;
    private String iuServicios;
    private int auxAbm;
    
    public JFrameRegistroServiciosPrestados() {
        initComponents();
// se personaliza las fuentes de letra de los objetos grafico
        ...
        jLabelTituloDescrServicios.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldDescrServicios.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
        jLabelTituloBuscarServicios.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldBuscarServicios.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
        jLabelTituloPrecioServ.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 6));
        jTextFieldPrecioServ.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 7));
...
// se personaliza el jTable    
        jTableServicios.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-ITALIC.otf", 0, 6));
        JTableHeader auxJTableHeader;
        auxJTableHeader = jTableServicios.getTableHeader();
        auxJTableHeader.setFont(Administrador.fuentesPersonalizada("/Multimedia/tipografias/OPENSANS-BOLDITALIC.otf", 0, 7));
// se instancia la clase AdministradorServiciosPrestados y se inicializa el menu del jTable
        _administradorServiciosPrestados = new AdministradorServiciosPrestados();
        popupMenuJTable();
        
        jTextFieldIuServicios.setEditable(false);
        jButtonEditarServicios.setEnabled(false);
        jButtonBorrarServicios.setEnabled(false);
        
                jPanelCuerpo.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{
            jTextFieldDescrServicios, jTextFieldPrecioServ}));
    }   
    ...
    private void initComponents() {
        ...
        jSeparatorBuscarServicios = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTableServicios = new javax.swing.JTable();
        jLabelTituloBuscarServicios = new javax.swing.JLabel();
        jTextFieldBuscarServicios = new javax.swing.JTextField();
        jButtonTraerPanelCuerpo = new javax.swing.JButton();
        jLabelFondoVentanaBuscar = new javax.swing.JLabel();
        jPanelCuerpo = new javax.swing.JPanel();
        jTextFieldPrecioServ = new javax.swing.JTextField();
        jSeparatorPrecioServ = new javax.swing.JSeparator();
        jLabelTituloPrecioServ = new javax.swing.JLabel();
        jLabelTituloDescrServicios = new javax.swing.JLabel();
        jTextFieldDescrServicios = new javax.swing.JTextField();
        jSeparatorDescrServicios = new javax.swing.JSeparator();
        ...
        jButtonAgregarServicios = new javax.swing.JButton();
        jButtonEditarServicios = new javax.swing.JButton();
        jButtonBorrarServicios = new javax.swing.JButton();
        ...
        jSeparatorBuscarServicios.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorBuscarServicios.setForeground(new java.awt.Color(0, 0, 0));
        jPanelVentanaBuscar.add(jSeparatorBuscarServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 55, 100, 2));
        ...
        jTableServicios.setToolTipText("Has click derecho para opciones.");
        jTableServicios.setAutoscrolls(false);
        jTableServicios.setFocusable(false);
        jTableServicios.setMaximumSize(new java.awt.Dimension(480, 250));
        jTableServicios.setMinimumSize(new java.awt.Dimension(480, 250));
        jTableServicios.setPreferredSize(new java.awt.Dimension(480, 250));
        jTableServicios.setSelectionBackground(new java.awt.Color(73, 73, 73));
        jTableServicios.setSelectionForeground(new java.awt.Color(245, 245, 245));
        jTableServicios.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jTableServicios);

        jPanelVentanaBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 480, 220));

        jLabelTituloBuscarServicios.setText("Parametro de busqueda:");
        jPanelVentanaBuscar.add(jLabelTituloBuscarServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 10, -1, 25));

        jTextFieldBuscarServicios.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldBuscarServicios.setToolTipText("ingresa parametros de busqueda. Ej: sell");
        jTextFieldBuscarServicios.setBorder(null);
        jTextFieldBuscarServicios.setDisabledTextColor(new java.awt.Color(194, 4, 48));
        jTextFieldBuscarServicios.setOpaque(false);
        jTextFieldBuscarServicios.setSelectionColor(new java.awt.Color(73, 73, 73));
        jTextFieldBuscarServicios.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBuscarServiciosKeyReleased(evt);
            }
        });
        jPanelVentanaBuscar.add(jTextFieldBuscarServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 35, 100, 20));
        ...
        jTextFieldPrecioServ.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldPrecioServ.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldPrecioServ.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldPrecioServ.setToolTipText("Ingrese solo decimales. Ej.: 3456.00");
        jTextFieldPrecioServ.setBorder(null);
        jTextFieldPrecioServ.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldPrecioServ.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldPrecioServ.setOpaque(false);
        jTextFieldPrecioServ.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldPrecioServ.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldPrecioServ, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 196, 200, 20));

        jSeparatorPrecioServ.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorPrecioServ.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorPrecioServ.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorPrecioServ.setOpaque(true);
        jPanelCuerpo.add(jSeparatorPrecioServ, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 216, 200, -1));

        jLabelTituloPrecioServ.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloPrecioServ.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloPrecioServ.setText("Precio del servicio:");
        jLabelTituloPrecioServ.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloPrecioServ, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 176, -1, 25));

        jLabelTituloDescrServicios.setFont(new java.awt.Font("Open Sans Extrabold", 0, 8)); // NOI18N
        jLabelTituloDescrServicios.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelTituloDescrServicios.setText("Servicio a prestar:");
        jLabelTituloDescrServicios.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloDescrServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 98, -1, 25));

        jTextFieldDescrServicios.setBackground(new java.awt.Color(245, 245, 245));
        jTextFieldDescrServicios.setFont(new java.awt.Font("Open Sans Extrabold", 0, 14)); // NOI18N
        jTextFieldDescrServicios.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldDescrServicios.setToolTipText("Ingrese solo texto. Ej.: sellado");
        jTextFieldDescrServicios.setBorder(null);
        jTextFieldDescrServicios.setMaximumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrServicios.setMinimumSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrServicios.setOpaque(false);
        jTextFieldDescrServicios.setPreferredSize(new java.awt.Dimension(25, 100));
        jTextFieldDescrServicios.setSelectionColor(new java.awt.Color(194, 4, 48));
        jPanelCuerpo.add(jTextFieldDescrServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 118, 200, 20));

        jSeparatorDescrServicios.setBackground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrServicios.setForeground(new java.awt.Color(0, 0, 0));
        jSeparatorDescrServicios.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jSeparatorDescrServicios.setOpaque(true);
        jPanelCuerpo.add(jSeparatorDescrServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 138, 200, -1));
        ...
        jPanelCuerpo.add(jSeparatorIuServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 66, 100, -1));
        ...
        jLabelTituloIuServicios.setText("Codigo identificacion:");
        jLabelTituloIuServicios.setToolTipText("");
        jPanelCuerpo.add(jLabelTituloIuServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 25, -1, 25));
        ...
        jTextFieldIuServicios.setText("AUTOMATICO");
        jTextFieldIuServicios.setToolTipText("");
        ...
        jPanelCuerpo.add(jTextFieldIuServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 45, 100, 20));

        jButtonAgregarServicios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOff.png"))); // NOI18N
        jButtonAgregarServicios.setToolTipText("Has click para agregar.");
        jButtonAgregarServicios.setBorder(null);
        jButtonAgregarServicios.setBorderPainted(false);
        jButtonAgregarServicios.setContentAreaFilled(false);
        jButtonAgregarServicios.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonAgregarServicios.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarServicios.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25AgregarOn.png"))); // NOI18N
        jButtonAgregarServicios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAgregarServiciosActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonAgregarServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 251, -1, -1));

        jButtonEditarServicios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOff.png"))); // NOI18N
        jButtonEditarServicios.setToolTipText("Has click para editar.");
        jButtonEditarServicios.setBorder(null);
        jButtonEditarServicios.setBorderPainted(false);
        jButtonEditarServicios.setContentAreaFilled(false);
        jButtonEditarServicios.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonEditarServicios.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarServicios.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25EditarOn.png"))); // NOI18N
        jButtonEditarServicios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEditarServiciosActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonEditarServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 251, -1, -1));

        jButtonBorrarServicios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOff.png"))); // NOI18N
        jButtonBorrarServicios.setToolTipText("Has click para borrar.");
        jButtonBorrarServicios.setBorder(null);
        jButtonBorrarServicios.setBorderPainted(false);
        jButtonBorrarServicios.setContentAreaFilled(false);
        jButtonBorrarServicios.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonBorrarServicios.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarServicios.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Multimedia/botones/boton100x25BorrarOn.png"))); // NOI18N
        jButtonBorrarServicios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonBorrarServiciosActionPerformed(evt);
            }
        });
        jPanelCuerpo.add(jButtonBorrarServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 251, -1, -1));
        ...
        jLabelTituloVentana.setText("Registro de servicios prestados");
...
// se crea un objeto de la clase utilizada    
    public void crearObjTipoPagos(){
        ...
        _objServiciosPrestados = new ServiciosPrestados();
        _objServiciosPrestados.setIuServicios(Integer.parseInt(jTextFieldIuServicios.getText()));
        _objServiciosPrestados.setDescrServicio(jTextFieldDescrServicios.getText());
        _objServiciosPrestados.setPrecioServ(Double.parseDouble(jTextFieldPrecioServ.getText()));
     }
...
// limpia los jtextfield usados
    public void limpiarCampos(){
        ...
        jTextFieldIuServicios.setText("AUTOMATICO");
        jTextFieldDescrServicios.setText(""); 
        jTextFieldPrecioServ.setText("");
        }
...
//se crean las opciones del menu
        JPopupMenu jPopupMenuTableHSP = new JPopupMenu();
        JMenuItem jMenuItemEliminarServiciosPrestados = new JMenuItem("Eliminar"); // cambiar x ico 
        JMenuItem jMenuItemModificarServiciosPrestados = new JMenuItem("Modificar");
...
// se generan las acciones de cada opcion
        jMenuItemEliminarServiciosPrestados.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarServicios.setEnabled(false);
            jButtonEditarServicios.setEnabled(false);
            jTextFieldDescrServicios.setEditable(false); 
            jTextFieldPrecioServ.setEditable(false);
       
            jButtonBorrarServicios.setEnabled(true);
             }
         });
         
        jMenuItemModificarServiciosPrestados.addActionListener((ActionEvent e) -> {
        ...
        if(seleccionarItemJTabla()!= -1){
            ...
            jButtonAgregarServicios.setEnabled(false);
            jButtonBorrarServicios.setEnabled(false); 
            jButtonEditarServicios.setEnabled(true);
        }
        });
             
        jMenuItemUltimosAgregados.addActionListener((ActionEvent e) -> {
            _administradorServiciosPrestados.ordenarTabla(jMenuItemUltimosAgregados.getText());
            jTableServicios.setModel( _administradorServiciosPrestados.cargarJTabla());
        });
                
        jMenuItemAlfabeticos.addActionListener((ActionEvent e) -> {
            _administradorServiciosPrestados.ordenarTabla(jMenuItemAlfabeticos.getText());
            jTableServicios.setModel( _administradorServiciosPrestados.cargarJTabla());
        });
                                
        jMenuItemPrimerosAgregados.addActionListener((ActionEvent e) -> {
            _administradorServiciosPrestados.ordenarTabla(jMenuItemPrimerosAgregados.getText());
            jTableServicios.setModel( _administradorServiciosPrestados.cargarJTabla());
        });
// se construye el menu completo y se le asigna si jTable
        jPopupMenuTableHSP.add(jMenuItemEliminarServiciosPrestados);
        jPopupMenuTableHSP.add(jMenuItemModificarServiciosPrestados);
        jPopupMenuTableHSP.add(jMenuOrdenar);
        jTableServicios.setComponentPopupMenu(jPopupMenuTableHSP);  
     }
...
// se obtiene el modelo y se verifica que se haya seleccionado un item   
        modeloTablaSP = jTableServicios.getModel();
        int auxSeleccion = jTableServicios.getSelectedRow();
        if (auxSeleccion != -1) {
            jTableServicios.setEnabled(true);
// se cargan los campos con los valores selcionados
            iuServicios =  (String)modeloTablaSP.getValueAt(jTableServicios.getSelectedRow(), 0);
            jTextFieldIuServicios.setText(iuServicios);
            jTextFieldDescrServicios.setText((String)modeloTablaSP.getValueAt(jTableServicios.getSelectedRow(), 1));
            jTextFieldPrecioServ.setText((String)modeloTablaSP.getValueAt(jTableServicios.getSelectedRow(),2));
            return auxSeleccion;
...
// valida datos y agrega a tabla serviciosPrestados un registro 
    private void jButtonAgregarServiciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarServiciosActionPerformed
        ...
        jTextFieldDescrServicios.setEditable(false);
        jTextFieldPrecioServ.setEditable(false);
    }//GEN-LAST:event_jButtonAgregarServiciosActionPerformed

//valida datos y edita un registro en tabla serviciosPrestados
    private void jButtonEditarServiciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarServiciosActionPerformed
        ...
        jTextFieldDescrServicios.setEditable(false);
        jTextFieldPrecioServ.setEditable(false);
    }//GEN-LAST:event_jButtonEditarServiciosActionPerformed

//valida datos y borra un registro en tabla serviciosPrestados 
    private void jButtonBorrarServiciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarServiciosActionPerformed
        ...
        jTextFieldDescrServicios.setEditable(false);
        jTextFieldPrecioServ.setEditable(false);
    }//GEN-LAST:event_jButtonBorrarServiciosActionPerformed

// con cada tecleo valida los datos y elimina los no correctos
    private void jTextFieldBuscarServiciosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscarServiciosKeyReleased
    ...
    try {
        ...
        if(auxValidar==false){
            ...
            evt.consume();
            jTableServicios.setModel(_administradorServiciosPrestados.buscarEnTabla(jTextFieldBuscarServicios.getText()));
    ...
    }//GEN-LAST:event_jTextFieldBuscarServiciosKeyReleased
...
//esconde el panel y habilita los obj en pantalla
    private void jButtonCancelarValidarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarValidarCambiosActionPerformed
        ...
        limpiarCampos();
        jPanelMensajeValidarABM.setBounds(-260, 100, 250, 100);
        jButtonAgregarServicios.setEnabled(true);
        jButtonEditarServicios.setEnabled(false);
        jButtonBorrarServicios.setEnabled(false);
        jButtonTraerPanelBuscar.setEnabled(true);
        jTextFieldDescrServicios.setEditable(true);
        jTextFieldPrecioServ.setEditable(true);
        jTextFieldDescrServicios.setBorder(null);
...
// se validan los datos
                aux2 = jTextFieldDescrServicios.getText();
                auxValidar2 = Administrador.validarCamposTextos(aux2,"[a-zA-Z]||[\\s]");
                aux =  jTextFieldPrecioServ.getText();
                auxValidar = Administrador.validarCamposDoubles(aux);
// si es correcto se crea el objeto de la clase usada
                if(auxValidar2==true && auxValidar==true){

                    jTextFieldDescrServicios.setBorder(new LineBorder(Color.green));
                    _objServiciosPrestados = new ServiciosPrestados();
                    _objServiciosPrestados.setDescrServicio(jTextFieldDescrServicios.getText());
                    _objServiciosPrestados.setPrecioServ(Double.parseDouble(jTextFieldPrecioServ.getText()));
// se avisa en caso de estar apagada la db y si no se agrega un item a la db
    try {
                    if(_administradorServiciosPrestados.insertarTablaServiciosPrestados(_objServiciosPrestados)==true){
...
// en caso de no ser validos los datos se avisa al usuario
                } else if(auxValidar2==false && auxValidar==true){
                    
                    jTextFieldPrecioServ.setBorder(new LineBorder(Color.green));
                    jTextFieldDescrServicios.setBorder(new LineBorder(Color.red));
                    jPanelGuardadoErroneo.setBounds(225, 100, 250, 100); 
                    
                } else if(auxValidar2==true && auxValidar==false){
                    
                    jTextFieldPrecioServ.setBorder(new LineBorder(Color.red));
                    jTextFieldDescrServicios.setBorder(new LineBorder(Color.green));
                    jPanelGuardadoErroneo.setBounds(225, 100, 250, 100); 
                    
                } else if(auxValidar2==false && auxValidar==false){
...
// se repite el mismo codigo solo que se edita un item de la db 
            case 2:
                ...
                if(auxValidar2==true && auxValidar==true){
                    ...
                    crearObjTipoPagos();
    try {
                if(_administradorServiciosPrestados.actualizarTablaServiciosPrestados(_objServiciosPrestados)==true){
...
// se repite el mismo codigo solo que se borra un item de la db         
            case 3:
                ...
                if(auxValidar2==true && auxValidar==true){
                    ...
                    crearObjTipoPagos();
    try {
                if(_administradorServiciosPrestados.eliminarTablaServiciosPrestados(_objServiciosPrestados)==true){   
...
// se acomoda los objetos del frame para continuar trabajando. 
    ...
    private javax.swing.JButton jButtonAgregarServicios;
    private javax.swing.JButton jButtonBorrarServicios;
    private javax.swing.JButton jButtonCancelar;
    private javax.swing.JButton jButtonCancelarValidarCambios;
    private javax.swing.JButton jButtonCerrar;
    private javax.swing.JButton jButtonEditarServicios;
    ...
    private javax.swing.JLabel jLabelTituloBuscarServicios;
    private javax.swing.JLabel jLabelTituloDescrServicios;
    private javax.swing.JLabel jLabelTituloIuServicios;
    private javax.swing.JLabel jLabelTituloPrecioServ;
    ...
    private javax.swing.JSeparator jSeparatorBuscarServicios;
    private javax.swing.JSeparator jSeparatorDescrServicios;
    private javax.swing.JSeparator jSeparatorIuServicios;
    private javax.swing.JSeparator jSeparatorPrecioServ;
    private javax.swing.JTable jTableServicios;
    private javax.swing.JTextField jTextFieldBuscarServicios;
    private javax.swing.JTextField jTextFieldDescrServicios;
    private javax.swing.JTextField jTextFieldIuServicios;
    private javax.swing.JTextField jTextFieldPrecioServ;
